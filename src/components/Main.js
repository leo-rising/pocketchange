    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="wallet" className={`${this.props.article === 'wallet' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          <h2 className="major">Are you ready?</h2>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          <h2 className="major">Be the change.</h2>
          <span className="image main"><img src={pic01} alt="" /></span>
          <p>The change in your pocket is enough to make a change.</p>
          {close}
        </article>

        <article id="go" className={`${this.props.article === 'go' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          <h2 className="major">Are you ready?</h2>
          <span className="image main"><img src={pic01} alt="" /></span>
          <p>Be the change. Spare your change.</p>
          {close}
